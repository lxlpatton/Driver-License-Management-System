...
HashMap mmm = new CommDAO().getmaps("jiaoshigonghao",(String)request.getSession().getAttribute("username"),"jiaoshixinxi"); 
%>
  <form  action="jiaoshixinxi_modf2.jsp?f=f&id=<%=mmm.get("id")%>"  method="post" name="form1"  onsubmit="return checkform();">
  修改教练信息:
  <br><br>
  <%
