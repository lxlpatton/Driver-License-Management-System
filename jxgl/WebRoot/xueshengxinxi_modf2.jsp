...
HashMap mmm = new CommDAO().getmaps("xueshengxuehao",(String)request.getSession().getAttribute("username"),"xueshengxinxi"); 
%>
  <form  action="xueshengxinxi_modf2.jsp?f=f&id=<%=mmm.get("id")%>"  method="post" name="form1"  onsubmit="return checkform();">
  修改学生信息:
  <br><br>
  <%
   ...
   <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#ADCEEF" style="border-collapse:collapse">  
    ...
    <tr><td>学员学号：</td><td><input name='xueshengxuehao' type='text' id='xueshengxuehao' value='<%= mmm.get("xueshengxuehao")%>' /></td></tr>
