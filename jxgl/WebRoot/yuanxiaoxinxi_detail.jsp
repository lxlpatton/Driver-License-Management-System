...
<html>
  ...
  <br><br>
   ...
   <tr>
   <td width='11%' height=44>校区：</td><td width='39%'><%=m.get("yuanxiao")%></td>
   </tr><tr>
   
      <td width='11%' height=100  >校区简介：</td><td width='39%' colspan=2 height=100 ><%=m.get("yuanxiaojianjie")%></td></tr><tr>
