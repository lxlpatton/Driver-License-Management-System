                ...
                <ul>
                    <li id="menu_0" onMouseOver="Menus.Show(this,0)" onClick="getleftbar(this);"><a href="#">
                        ...
                        <div class="menu_childs" onMouseOut="Menus.Hide(0);">
                            <ul>
                                <li><a href="xtyhgl.jsp" target="frmright">管理员管理</a> </li>
                    ...
                    <li id="menu_1" onMouseOver="Menus.Show(this,0)" onClick="getleftbar(this);"><a href="#">
                        ...
                        <div class="menu_childs" onMouseOut="Menus.Hide(0);">
                            <ul>
                                <li><a href="yuanxiaoxinxi_add.jsp" target="frmright">校区信息添加</a> </li>
                    ...
                    <li id="menu_2" onMouseOver="Menus.Show(this,0)" onClick="getleftbar(this);"><a href="#">
                       车辆信息</a>
                        <div class="menu_childs" onMouseOut="Menus.Hide(0);">
                            <ul>
                                <li><a href="zhuanyexinxi_add.jsp" target="frmright">车辆信息添加</a> </li>
                    ...
                    <li id="menu_3" onMouseOver="Menus.Show(this,0)" onClick="getleftbar(this);"><a href="#">
                        ...
                        <div class="menu_childs" onMouseOut="Menus.Hide(0);">
                            <ul>
                                <li><a href="jiaoshixinxi_add.jsp" target="frmright">教练信息添加</a> </li>
                                <li><a href="jiaoshixinxi_list.jsp" target="frmright">教练信息查询</a> </li>
								</ul>
                        </div>
                        <div class="menu_div">
                            <img style="vertical-align: bottom" src="images/menu01_right.gif"></div>
                    ...
                    <li id="menu_4" onMouseOver="Menus.Show(this,0)" onClick="getleftbar(this);"><a href="#">
                        ...
                        <div class="menu_childs" onMouseOut="Menus.Hide(0);">
                            <ul>
                                <li><a href="xueshengxinxi_add.jsp" target="frmright">学员信息添加</a> </li>
                                <li><a href="xueshengxinxi_list.jsp" target="frmright">学员信息查询</a> </li>
                            </ul>
                        </div>
                        <div class="menu_div">
                            <img style="vertical-align: bottom" src="images/menu01_right.gif"></div>
                    ...
                    <li id="menu_5" onMouseOver="Menus.Show(this,0)" onClick="getleftbar(this);"><a href="#">
                        ...
                        <div class="menu_childs" onMouseOut="Menus.Hide(0);">
                            <ul>
                                <li><a href="kemuxinxi_add.jsp" target="frmright">科目信息添加</a> </li>
                                <li><a href="kemuxinxi_list.jsp" target="frmright">科目信息查询</a> </li>
                            </ul>
                        </div>
                        <div class="menu_div">
                            <img style="vertical-align: bottom" src="images/menu01_right.gif"></div>
                   ...
                   <li id="menu_8" onMouseOver="Menus.Show(this,0)" onClick="getleftbar(this);"><a href="#">
                        ...
                        <div class="menu_childs" onMouseOut="Menus.Hide(0);">
                            <ul>
                                <li><a href="newsproclaim_add.jsp" target="frmright">通知公告添加</a> </li>
                                <li><a href="newsproclaim_list.jsp" target="frmright">通知公告查询</a> </li>
                            </ul>
                        </div>
                        <div class="menu_div">
                            <img style="vertical-align: bottom" src="images/menu01_right.gif"></div>
        ...
        <tbody>
            <tr>
                <td class="main_left" id="frmTitle" valign="top" align="middle" name="fmTitle">
                    ...
                    <iframe class="left_iframe" id="frmleft" name="frmleft" src="left.html" frameborder="0"
                        ...
                        <tbody>
                            <tr height="32">
                                ...
                                <td background="images/bg2.gif">
                                    <span style="float: left">驾校学员管理系统</span><span id="dvbbsannounce"
