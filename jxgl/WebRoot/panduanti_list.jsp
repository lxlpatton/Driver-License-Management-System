...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#ADCEEF" style="border-collapse:collapse">  
  ...
  <tr>
    ...
    <td width="60" align="center"><a href="panduanti_modf.jsp?id=<%=map.get("id")%>">修改</a>  <a href="panduanti_list.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a> <a href="panduanti_detail.jsp?id=<%=map.get("id")%>">详细</a> </td>
  </tr>
  	<%
  }
   %>
