...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#ADCEEF" style="border-collapse:collapse">  
  ...
  <tr>
    ...
    <td width="60" align="center"><a href="shijuanshengcheng_modf.jsp?id=<%=map.get("id")%>">修改</a>  <a href="shijuanshengcheng_list.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a> <a href="shijuan_detail2.jsp?id=<%=map.get("id")%>">试卷查看</a> </td>
  </tr>
  	<%
  }
   %>
